...
---
# 《企業生成式 AI 轉型全書：從知識底座到自主代理人的實踐路徑》 (v1.6.0)

## 第 0 章 虛擬企業實踐原型：團隊協作脈絡對合與 AI 賦能實測
- **0.1 演化路徑**：企業賦能的碎形邏輯：個人為基，團隊為原型。
- **0.2 協作格律**：人機混編團隊的數位契約與**工作流程節點地圖 (Node Map)** 繪製。 [v1.6.0]
...
- **2.2 企業 Skill Map (技能地圖) 與知識底座之建構**：如何以 Skill Map 對應企業職能需求並進行機器可讀知識（L0 到 L3）的物理入庫。 [v1.6.0]
...
- **3.3 多代理系統 (MAS) 協作**：多代理系統 (MAS) 協作：**SOP 轉 Skill 的封裝邏輯**與高階虛擬決策角色定位。 [v1.6.0]
- **3.4 企業內部 Agent 市集 (Internal Agent Marketplace) 與 Agentic Platform 的設計與實踐**：定義平台架構，如何串聯建構團隊與使用團隊。 [v1.6.0]
- **3.5 本章回顧與自測**：檢驗對於自動化代理推理邏輯與多機協作概念的認知。

## 第 4 章 落地運維與安全治理：AgentOps 的挑戰
- **4.1 混合架構選擇**：閉源商用 (OpenAI/Claude) 與開源私有化 (Llama) 的權衡與部署。
- **4.2 AgentOps 與效能監控**：AgentOps 與效能監控：**Skill 的 CI/CD 生命週期管理**、活躍率監控與成本控制。 [v1.6.0]
