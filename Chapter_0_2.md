# 0.2 協作格律：人機混編團隊的數位契約與工作流程節點地圖 (Node Map) 繪製
...
## 0.2.3 工作流程節點地圖 (Node Map) 繪製

在實務運作中，為了避免任務在人機接力之間遺失，我們引入了 **「智慧工程 (Intelligent Engineering)」** 的核心手法：**工作流程節點地圖 (Node Map)** 的繪製。
...
3.  **效能與流速量化**：計算各個節點之間的資料傳遞延遲與 Token 消耗效能。當流程在某個節點發生停滯（例如因 Prompt 語意不清導致 Agent 陷入重複自我修正）時，地圖上的瓶頸會立刻浮現。
